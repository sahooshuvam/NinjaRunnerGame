...
namespace Ruccho.Utilities
{
    ...
    (
        ...
        private void CreateTextureAndSprites(Color[][][][] parts, Color[][][][][] customTextureParts, int texSize, int tileSize, int frameCount, bool forceRegenerate = false)
        {
            ...
            bool texSizeUnchanged = false;
            if (tile.Texture && tile.Texture.width == texSize)
            {
                texSizeUnchanged = true;
            }
            ...
            replaceMode = texSizeUnchanged && frameCountUnchanged && tileSizeUnchanged && !forceRegenerate && pixPerUnitUnchanged && paddingUnchanged;
            ...
            else
            {
                ...
                mainTex = new Texture2D(texSize, texSize, TextureFormat.RGBA32, false);
            }
